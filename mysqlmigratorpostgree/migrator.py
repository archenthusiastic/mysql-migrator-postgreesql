from mysqlmigratorpostgree.connect_mysql import connect_mysql
from mysqlmigratorpostgree.connect_postgresql import connect_postgresql

class MysqlMigratorPostgree:
    def __init__(self):
